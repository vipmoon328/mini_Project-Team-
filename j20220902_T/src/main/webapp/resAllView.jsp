...
<script type="text/javascript">
	...
	function print_message(){
		...
		text += "금액 : " + cost + "원 <input type='hidden' name='cost' value='" + cost +"'>";
		$('#msg').html(text);
	}
	...
	function buildTimeTable(data) {
		...
		if(!('${ brnNum }' ==null || '${ brnNum }' == '')){
			$("#test td").not('.impossible').removeClass('possible').css('background-color', 'lightgray');
			if((today.getFullYear() == inputDay.getFullYear())&&(today.getMonth() == inputDay.getMonth())&&(today.getDate() == inputDay.getDate())&&($("#jijum option:selected").text() == '${ brnNum }')){
