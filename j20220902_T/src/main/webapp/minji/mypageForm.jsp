			...
			<div class="item_fifth"> 
				<table width="700px">
					...
					<tr>
						...
						<td>
							<label for="loc">
								<input type="radio" name="loc" value="0"><span>이대</span>
								<input type="radio" name="loc" value="1"><span>강남</span>
							</label>
						</td>
					</tr>
					<tr>
						...
						<td>
							<label for="user_email">
								<input type="text" class="email" name="user_email1" id="user_email1" required="required"> @ <input type="text" class="email" name="user_email2" id="user_email2" required="required">
