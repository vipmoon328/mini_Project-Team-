...
<body>
	...
	<div class="flex-container center">
		...
		<ul>		
			<li><a href="#content1">볼링장전경</a></li>
			<li><a href="#content2">볼링장시설</a></li>
			<li><a href="#content3">이용안내</a></li>
		</ul>
		</div>
	</div>			
	<div id="main_textbox">
		<div id="content1"  class="name"><h2>볼링장전경</h2></div>
			<div id="main_text">
	...
	<div id="main_textbox">
		<div id="content2" class="name"><h2>볼링장시설</h2></div>
			<div id="main_text">
		...
		<div id="main_textbox">
			<div id="content3"  class="name"><h2>이용안내</h2></div>	
